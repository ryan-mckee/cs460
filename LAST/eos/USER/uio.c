...
int S_ISREG(int st_mode)
{
  return (st_mode & 0xF000) == 0x8000;
}

int S_ISDIR(int st_mode)
{
  return (st_mode & 0xF000) == 0x4000;
}

int S_ISLNK(int st_mode)
{
  return (st_mode & 0xF000) == 0xA000;
}
